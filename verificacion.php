              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form action="verificacion.php" method="POST">
                    ...
                    <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Verifique sesion</h5>

                    <div class="form-outline mb-4">
                      <input name="email" type="email" id="form2Example17" class="form-control form-control-lg" placeholder="Ingrese su Correo" />
                    </div>

                    <div class="form-outline mb-4">
                      <input name="password" type="password" id="form2Example27" class="form-control form-control-lg" placeholder="Ingrese su Contraseña" />
                    </div>
